...
public final class OnlineBookPrxHelper extends Ice.ObjectPrxHelperBase implements OnlineBookPrx
{
    ...
    {
        return bookTick(message, null, false);
    }

    public Message bookTick(Message message, java.util.Map<String, String> __ctx)
    {
        return bookTick(message, __ctx, true);
    }

    private Message bookTick(Message message, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        __checkTwowayOnly(__bookTick_name);
        return end_bookTick(begin_bookTick(message, __ctx, __explicitCtx, true, null));
    }

    public Ice.AsyncResult begin_bookTick(Message message)
    {
        return begin_bookTick(message, null, false, false, null);
    }

    public Ice.AsyncResult begin_bookTick(Message message, java.util.Map<String, String> __ctx)
    {
        return begin_bookTick(message, __ctx, true, false, null);
    }

    public Ice.AsyncResult begin_bookTick(Message message, Ice.Callback __cb)
    {
        return begin_bookTick(message, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_bookTick(Message message, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_bookTick(message, __ctx, true, false, __cb);
    }
    ...
    {
        return begin_bookTick(message, null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    {
        return begin_bookTick(message, null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_bookTick(Message message, 
                                          ...
                                          IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_bookTick(message, __ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_bookTick(Message message, 
                                          ...
                                          IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_bookTick(message, __ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_bookTick(Message message, 
                                           java.util.Map<String, String> __ctx, 
                                           ...
                                           IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_bookTick(message, __ctx, __explicitCtx, __synchronous, 
                              new IceInternal.Functional_TwowayCallbackArg1<cn.didadu.generate.book.Message>(__responseCb, __exceptionCb, __sentCb)
                                  {
    ...
    {
        cn.didadu.generate.book.OnlineBookPrx __proxy = (cn.didadu.generate.book.OnlineBookPrx)__result.getProxy();
        Message __ret = null;
        try
        {
